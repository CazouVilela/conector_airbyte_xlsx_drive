# conector_airbyte_xlsx_drive - Memória do Projeto
...
[Descrição do projeto a ser preenchida]
...
<!-- CHAPTER: 4 Configurações -->

## ⚙️ Configurações

**Variáveis de Ambiente**: [A definir]
**Portas**: [A definir]
**Caminhos Importantes**: [A definir]
